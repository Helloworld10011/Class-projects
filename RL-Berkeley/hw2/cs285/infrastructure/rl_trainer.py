...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        self.params['agent_params']['discrete'] = self.discrete
...
#        else:
        ...
        paths, envsteps_this_batch = sample_trajectories(self.env, collect_policy, batch_size, self.params['ep_len'], discrete= self.discrete)
        ...
        if self.log_video:
            ...
            train_video_paths = sample_n_trajectories(self.env, collect_policy, MAX_NVIDEO, MAX_VIDEO_LEN, True, discrete= self.discrete)
    ...
    def train_agent(self):
        ...
        if (self.params['num_agent_train_steps_per_iter']//5) >= 1:
            steep= True
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths):
        ...
        eval_paths, eval_envsteps_this_batch = sample_trajectories(self.env, eval_policy, self.params['eval_batch_size'], self.params['ep_len'], discrete= self.discrete)

        # save eval rollouts as videos in tensorboard event file
        if self.log_video and train_video_paths != None:
            print('\nCollecting video rollouts eval')
            eval_video_paths = sample_n_trajectories(self.env, eval_policy, MAX_NVIDEO, MAX_VIDEO_LEN, True, discrete= self.discrete)
