...
class RL_Trainer(object):
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            if isinstance(self.agent, ACAgent):
                loss_critic= loss['Critic_Loss']
                loss_actor= loss['Actor_Loss']
                self.logger.log_scalar(loss_critic, "Critic_Losses", self.counter)
                self.logger.log_scalar(loss_actor, "Critic_Losses", self.counter)
            else:
