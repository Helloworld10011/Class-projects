...
class DQNCritic(BaseCritic):
    ...
    def _build(self, q_func):
        ...
        #q_tp1_values = q_func(self.obs_tp1_ph, self.ac_dim, scope='q_func', reuse=True)
        ...
        if self.double_q:
            ...
            indices= tf.one_hot(tf.argmax(self.q_t_values, axis= 1), self.ac_dim)
            q_tp1 = tf.reduce_sum(q_tp1_values * indices, axis= 1)
...
#        l, _= self.sess.run([self.total_error, self.update_target_fn], feed_dict= {self.obs_t_ph: ob_no,
