...
contract CustomERC20 {
    ...
    constructor (uint256 total) internal {
        _totalSupply = total;
    ...
    modifier whenNotPaused() {
        ...
        //paused should be false to not to be paused!
        _;
    }
    ...
    function isPauser(address account) private view returns (bool) {
        //if account is pauser returns true!
        bool result;
        if (account == _pauser){
            result = true;
        } else {
    ...
    function totalSupply() public view returns (uint256) {
        //becuase _totalSupply is private we use this function:
        return _totalSupply;
    }
