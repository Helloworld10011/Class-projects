...
if __name__ == '__main__':
    ...
    private_key = CBitcoinSecret("cTebtqRFAL2W7Stn8CVPfhNH57eT7K46jAiShFBB2dprxHBPpBY3")
    public_key = private_key.pub
    address = P2PKHBitcoinAddress.from_pubkey(public_key)

    amount_to_send = 0.0312 # amount of BTC in the output you're splitting minus fee
    txid_to_spend = (
        'a71b8ba6f2b85b48c569e48c50050b55900f7478832bba70608b1f24367d1655')
